...
public class UIRadioButton: UIButton {
    ...
    @IBOutlet var otherButtons: Array<UIRadioButton>?
    ...
    //      Margin width between icon and title, default is 5. 0.
    
    @IBInspectable public var marginWidth:CGFloat = 5.0
    ...
    private var setOtherButtons:NSArray {
        ...
        set (newValue) {
            if (!self.isGroupModifing()){
                ...
                let otherNewButtons:Array<UIRadioButton>? = newValue as? Array<UIRadioButton>
            ...
            self.otherButtons = newValue as? Array<UIRadioButton>
        }
    }
    ...
    func drawIconWithSelection (_ selected:Bool) -> UIImage{
        ...
        image.accessibilityIdentifier = UIRadioButton.kGeneratedIconName;
        return image;
    }
    ...
    func initRadioButton () {
        super.addTarget(self, action:#selector(UIRadioButton.touchDown), for:.touchUpInside)
        //        self.isSelected = false
    }
    ...
    func groupModifing(chaining:Bool) {
        UIRadioButton._groupModifing = chaining
    }
    
    func isGroupModifing() -> Bool {
        return UIRadioButton._groupModifing
    }
    
    //    @return Selected button in same group.
    
    public func selectedButton() -> UIRadioButton!{
