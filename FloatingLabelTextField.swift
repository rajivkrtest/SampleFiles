...
open class FloatingLabelTextField: UITextField {
    ...
    @IBInspectable dynamic open var lineColor: UIColor = .green {
        didSet {
            updateLineView()
        }
    }
    ...
    @IBInspectable dynamic open var selectedTitleColor: UIColor = .green {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var selectedLineColor: UIColor = .green {
        didSet {
            updateLineView()
        }
    }
