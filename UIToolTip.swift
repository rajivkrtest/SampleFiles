...
enum UIToolTipAnimation: Int {
    case slide = 0
    case pop
}

protocol UIToolTipDelegate {
    func popTipViewWasDismissedByUser(_ popTipView:UIToolTip)
}

class UIToolTip: UIView {
    var delegate: UIToolTipDelegate?
    ...
    var animation: UIToolTipAnimation = .slide
